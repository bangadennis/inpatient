...
<%--&lt;%&ndash;Date Time picker css and js&ndash;%&gt;--%>
...
<%--&lt;%&ndash;Data tables js and css&ndash;%&gt;--%>
<%--&lt;%&ndash;<openmrs:htmlInclude file="/moduleResources/inpatient/tablejs/jquery.dataTables.min.css" />&ndash;%&gt;--%>
